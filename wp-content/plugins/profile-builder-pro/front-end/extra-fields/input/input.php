	...
	if ( $field['field'] == 'Input' ){
		...
		if ( $form_location != 'back_end' ){
            ...
            $output = '
				...
				<input class="extra_field_input" name="'.$field['meta-name'].'" maxlength="'. apply_filters( 'wppb_maximum_character_length', 70, $field ) .'" type="text" id="'.$field['meta-name'].'" value="'. esc_attr( wp_unslash( $input_value ) ) .'" />';
            ...
            $output = '
				<table class="form-table">
					<tr>
						...
						<td>
							<input class="custom_field_input" size="45" name="'.$field['meta-name'].'" maxlength="'. apply_filters( 'wppb_maximum_character_length', 70, $field ) .'" type="text" id="'.$field['meta-name'].'" value="'. esc_attr( $input_value ) .'" />
