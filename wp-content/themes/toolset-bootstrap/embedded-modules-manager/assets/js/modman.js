        ...
        e = {
            ...
            init: function () {
                ...
                a(".wrap").on("click", "a.sidebar-name-arrow", function () {
                    var b = a(this);
                    b.hasClass("modman-open-details") ? (b.removeClass("modman-open-details"), b.parents(".module").find(".module-description").slideFadeUp("fast")) : (b.addClass("modman-open-details"), b.parents(".module").find(".module-description").slideFadeDown("fast"))
                });
                ...
                a("#module-list").find(".module").draggable({
            ...
            save: function () {
                ...
                a("#modules-right .modules-holder-wrap").length == 0 ? b.modules = [0] : a("#modules-right .modules-holder-wrap").each(function () {
                    ...
                    0 == a(this).find(".modules-sortables .module").length ? b.modules[c] = [0] : a(this).find(".modules-sortables .module").each(function () {
                        var d = a(this).find(".module-data .module-plugin").text(),
                            g = a(this).find(".module-data .module-item").text(),
                            e = a(this).find(".module-description").html();
                        e || (e = "");
                        var j = a(this).find(".module-title h4").clone().children().remove().end().text(),
                            j = a.trim(j);
            ...
            moduleData: function (b) {
                ...
                if (0 == $module.find(".modules-sortables .module").length) return !1;
                    ...
                    var b = a(this).find(".module-data .module-plugin").text(),
                        d = a(this).find(".module-data .module-item").text(),
                        e = a(this).find(".module-description").html(),
                        g = a(this).find(".module-title h4").clone().children().remove().end().text(),
                        g = a.trim(g);
                    e || (e = "");
