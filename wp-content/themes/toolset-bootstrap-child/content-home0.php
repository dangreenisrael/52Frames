...
<!-- Load the slider with "slider1" alias every time -->
      <?php //putRevSlider("homepage") ?>
          <article <?php post_class('clearfix') ?> id="post-<?php the_ID(); ?>">
             <div id="bg_container">
              <div class="vimeoFrame"><iframe class="vimeoXtra" src="//player.vimeo.com/video/115478018?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=1&amp;loop=1"  frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
              </div>
              ...
              <div class="submission-form-hp span3 pull-right">
                <div class="camera-text">
                  <a href="<?php echo home_url()?>/submit-new-photo/">This Weeks Challenge</a>
					...
					<p class="red-circle"><span class="submit-text">Submit</span><br /><span class="your-photo-text">Your Photo</span></p>
                  ...
                  // echo '<div id="carousel">';
                	 foreach ( $terms2 as $term2 ) {
                      ...
                      $variable = get_field('winning_photo_1th', 'photo_alboms_'.$term2->term_id);
                       echo '<div><div class="span3 winning_image"><a href="'.get_permalink($variable->ID).'">'.get_the_post_thumbnail($variable->ID, "full").'</a>';
                       echo '<div class="week-name"><div class="album-stats"><span class="week-number-hp">Week 47</span></br><a class="album-name-hp" href="'.esc_url( $term_link ).'">'.$term2->name.'</a></div></div></div></div>';
...
<div class="holder span3 text-center"><a class="button-arrows-hp" href="#">Next ></a></div>
	<div class="child span8">
			<div class="row-fluid">
				<div class="counters-hp">
					<div class="holder span3 counter-container text-center"><p class="counter">16067</p><p><span class="counter-bottom">Photographs Submitted</span></p></div>
					<div class="holder span3 counter-container text-center"><p class="counter">697</p><p><span class="counter-bottom">Photographers to Date</span></p></div>
					<div class="holder span3 counter-container text-center"><p class="counter">26</p><p><span class="counter-bottom">Countries Represented</span></p></div>
					<div class="holder span3 counter-container text-center"><p class="counter">208</p><p><span class="counter-bottom">Weekly Challenges</span></p></div>
...
<div class="latest-hp-margin"><a class="button-latest-hp" href="<?php echo get_permalink( get_option( 'page_for_posts' ) ); ?>">Visit Our Blog</a></div>
<?php
...
<div class="featured-name-photo"><div class="featured-name"><a class="featured-name-inner" href="#">Name of Photo</a></div></div>
</div>
<?php
...
if( $post_object ): 
  ...
  setup_postdata( $post ); 
  ?>
<div class="holder span4 winning_image" style="width:33.33%;"><?php $image = get_the_post_thumbnail($post->ID, 'full'); ?>
...
<div class="photo-title-hp"style="top: 250px;"><div class="title-hp"><span class="week-number-hp"><?php the_title();?></span></div></div>
<div class="photographer-name-hp"style="top: 400px;"><div class="photographer-hp"><a class="album-name-hp" href="<?php get_the_author_meta( 'user_url', $post->post_author ); ?>"><?php echo get_the_author_meta( 'user_nicename', $post->post_author ); ?></a></div></div>
