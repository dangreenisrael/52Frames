		...
		<?php
			...
			<div class="toolbar pull-left">
				...
				<ul class="social cf">
	                ...
	                <li class="twitter"><a href="http://twitter.com/share?text=Currently reading <?php the_title(); ?>&amp;url=<?php the_permalink(); ?>" class="popup" ><i class="fa fa-twitter"></i></a></li>
	                <li class="facebook"><a href="http://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>&amp;t=<?php the_title(); ?>" class="popup"><i class="fa fa-facebook"></i></a></li>
