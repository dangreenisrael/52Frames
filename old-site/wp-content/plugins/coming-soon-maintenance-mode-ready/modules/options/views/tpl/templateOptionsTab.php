...
<form id="cspAdminTemplateOptionsForm">
	<div>
		...
		<a href="<?php echo uriCsp::_(array('mod' => 'coming_soon'))?>" target="_blank" class="cspPreviewSiteTemplateOptionButton button button-primary button-large"><?php langCsp::_e('Show Preview')?><?php //echo htmlCsp::inputButton(array('value' => langCsp::_('Сhoose Preset template'), 'attrs' => 'class="cspSetTemplateOptionButton button button-primary button-large"')); ?></a>
	</div>
	<div class="wrap">
